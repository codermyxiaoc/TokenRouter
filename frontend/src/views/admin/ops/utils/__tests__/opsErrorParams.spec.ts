...
describe('buildOpsErrorTimeParams', () => {
  ...
  it('preserves predefined ranges and falls back for incomplete custom ranges', () => {
    ...
    expect(buildOpsErrorTimeParams('custom', '2026-08-01T00:00:00Z', null)).toEqual({ time_range: '1h' })
    expect(buildOpsErrorTimeParams('custom', null, '2026-08-02T00:00:00Z')).toEqual({ time_range: '1h' })
  })
})
