...
// Settings
    settings: {
      ...
      openaiFastPolicy: {
        ...
        description: 'Intercept, filter, or pass OpenAI fast(priority), ultrafast, or flex requests based on the request body service_tier field. Applies to the OpenAI gateway only. All tier values matches explicitly selected tiers. Choose Omitted tier with force priority to enable Fast for requests without a tier, subject to existing system and API key policies.',
