...
export async function list(
  ...
  filters?: {
    ...
    api_key_group_id?: number   // 按用户 API Key 绑定的分组过滤
 ...
 */
export type PlatformQuotaPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'qoder' | 'grok' | 'kimi' | 'zhipu' | 'deepseek' | 'minimax'
