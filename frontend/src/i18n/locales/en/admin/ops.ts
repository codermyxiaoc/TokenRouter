...
// Ops Monitoring
    ops: {
      ...
      diagnosis: {
        ...
        diskCritical: 'Disk usage critically high ({usage}%)',
        diskCriticalImpact: 'Writes to logs, cache, or database may fail',
        diskCriticalAction: 'Clean unused files, check log rotation, and expand disk capacity',
        diskHigh: 'Disk usage elevated ({usage}%)',
        diskHighImpact: 'Free disk space is low and needs attention',
        diskHighAction: 'Check large files and log growth, prepare cleanup or expansion',
      ...
      tooltips: {
        ...
        disk: 'Root filesystem disk usage, including used and total capacity.',
