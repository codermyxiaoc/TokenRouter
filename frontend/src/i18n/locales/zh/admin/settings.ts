...
// Settings
    settings: {
      ...
      openaiFastPolicy: {
        ...
        description: '基于请求体 service_tier 字段拦截/过滤/透传 OpenAI fast(priority)、ultrafast 与 flex 请求；仅作用于 OpenAI 网关。“全部 tier 值”只匹配已指定的档位；选择“未指定 tier”并强制 priority 可为缺省请求启用 Fast，仍受现有系统和密钥策略约束。',
