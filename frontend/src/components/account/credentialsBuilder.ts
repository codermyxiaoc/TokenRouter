...
// OpenCode 自适应按模型规则选协议；缺少模式的历史账号沿用 GO。
...
export const CN_BASE_URL_PRESETS: Record<'kimi' | 'zhipu' | 'deepseek' | 'minimax', CnBaseUrlPreset[]> = {
  ...
  // MiniMax 按量付费与 Coding Plan 使用相同协议端点，密钥区分计费模式。
  minimax: [
    { mode: 'payg', protocol: 'chat_completions', label: 'MiniMax Global', url: 'https://api.minimax.io/v1' },
    { mode: 'payg', protocol: 'anthropic', label: 'MiniMax Global Anthropic', url: 'https://api.minimax.io/anthropic' },
    { mode: 'payg', protocol: 'responses', label: 'MiniMax Global Responses', url: 'https://api.minimax.io/v1' },
    { mode: 'payg', protocol: 'chat_completions', label: 'MiniMax CN', url: 'https://api.minimax.cn/v1' },
    { mode: 'payg', protocol: 'anthropic', label: 'MiniMax CN Anthropic', url: 'https://api.minimax.cn/anthropic' },
    { mode: 'payg', protocol: 'responses', label: 'MiniMax CN Responses', url: 'https://api.minimax.cn/v1' },
    { mode: 'payg', protocol: 'chat_completions', label: 'MiniMax Legacy', url: 'https://api.minimaxi.com/v1' },
    { mode: 'payg', protocol: 'anthropic', label: 'MiniMax Legacy Anthropic', url: 'https://api.minimaxi.com/anthropic' },
    { mode: 'payg', protocol: 'responses', label: 'MiniMax Legacy Responses', url: 'https://api.minimaxi.com/v1' },
    { mode: 'coding', protocol: 'chat_completions', label: 'MiniMax Global Coding', url: 'https://api.minimax.io/v1' },
    { mode: 'coding', protocol: 'anthropic', label: 'MiniMax Global Coding Anthropic', url: 'https://api.minimax.io/anthropic' },
    { mode: 'coding', protocol: 'responses', label: 'MiniMax Global Coding Responses', url: 'https://api.minimax.io/v1' },
    { mode: 'coding', protocol: 'chat_completions', label: 'MiniMax CN Coding', url: 'https://api.minimax.cn/v1' },
    { mode: 'coding', protocol: 'anthropic', label: 'MiniMax CN Coding Anthropic', url: 'https://api.minimax.cn/anthropic' },
    { mode: 'coding', protocol: 'responses', label: 'MiniMax CN Coding Responses', url: 'https://api.minimax.cn/v1' },
    { mode: 'coding', protocol: 'chat_completions', label: 'MiniMax Legacy Coding', url: 'https://api.minimaxi.com/v1' },
    { mode: 'coding', protocol: 'anthropic', label: 'MiniMax Legacy Coding Anthropic', url: 'https://api.minimaxi.com/anthropic' },
    { mode: 'coding', protocol: 'responses', label: 'MiniMax Legacy Coding Responses', url: 'https://api.minimaxi.com/v1' }
  ],
  deepseek: [
...
/**
 * OpenAI plan_type 使用与账号徽标一致的展示名称，未知值原样返回。
 */
...
/**
 * 构建 plan_type 下拉选项：清空 + 既有 Plus/Pro/Free 原值预设。
...
export function buildPlanTypeOptions(current: string, clearLabel: string): PlanTypeOption[] {
  ...
  const presets: PlanTypeOption[] = [
    ...
    { value: 'pro', label: planTypeDisplayLabel('pro') },
