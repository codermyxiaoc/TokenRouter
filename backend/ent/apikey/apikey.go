...
const (
	...
	// FieldSmartRouting holds the string denoting the smart_routing field in the database.
	FieldSmartRouting = "smart_routing"
	// FieldSmartRoutingCooldownSeconds holds the string denoting the smart_routing_cooldown_seconds field in the database.
	FieldSmartRoutingCooldownSeconds = "smart_routing_cooldown_seconds"
...
var Columns = []string{
	...
	FieldIsComposite,
	FieldSmartRouting,
	FieldSmartRoutingCooldownSeconds,
	FieldStatus,
	FieldFastModePolicy,
	FieldBillingMode,
...
var (
	...
	// DefaultSmartRouting holds the default value on creation for the "smart_routing" field.
	DefaultSmartRouting bool
	// DefaultSmartRoutingCooldownSeconds holds the default value on creation for the "smart_routing_cooldown_seconds" field.
	DefaultSmartRoutingCooldownSeconds int
	// SmartRoutingCooldownSecondsValidator is a validator for the "smart_routing_cooldown_seconds" field. It is called by the builders before save.
	SmartRoutingCooldownSecondsValidator func(int) error
...
// BySmartRouting orders the results by the smart_routing field.
func BySmartRouting(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSmartRouting, opts...).ToFunc()
}

// BySmartRoutingCooldownSeconds orders the results by the smart_routing_cooldown_seconds field.
func BySmartRoutingCooldownSeconds(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSmartRoutingCooldownSeconds, opts...).ToFunc()
}
