...
// SetSmartRouting sets the "smart_routing" field.
func (_c *APIKeyCreate) SetSmartRouting(v bool) *APIKeyCreate {
	_c.mutation.SetSmartRouting(v)
	return _c
}

// SetNillableSmartRouting sets the "smart_routing" field if the given value is not nil.
func (_c *APIKeyCreate) SetNillableSmartRouting(v *bool) *APIKeyCreate {
	if v != nil {
		_c.SetSmartRouting(*v)
	}
	return _c
}

// SetSmartRoutingCooldownSeconds sets the "smart_routing_cooldown_seconds" field.
func (_c *APIKeyCreate) SetSmartRoutingCooldownSeconds(v int) *APIKeyCreate {
	_c.mutation.SetSmartRoutingCooldownSeconds(v)
	return _c
}

// SetNillableSmartRoutingCooldownSeconds sets the "smart_routing_cooldown_seconds" field if the given value is not nil.
func (_c *APIKeyCreate) SetNillableSmartRoutingCooldownSeconds(v *int) *APIKeyCreate {
	if v != nil {
		_c.SetSmartRoutingCooldownSeconds(*v)
	}
	return _c
}
...
func (_c *APIKeyCreate) defaults() error {
	...
	if _, ok := _c.mutation.SmartRouting(); !ok {
		v := apikey.DefaultSmartRouting
		_c.mutation.SetSmartRouting(v)
	}
	if _, ok := _c.mutation.SmartRoutingCooldownSeconds(); !ok {
		v := apikey.DefaultSmartRoutingCooldownSeconds
		_c.mutation.SetSmartRoutingCooldownSeconds(v)
	}
...
func (_c *APIKeyCreate) check() error {
	...
	if _, ok := _c.mutation.SmartRouting(); !ok {
		return &ValidationError{Name: "smart_routing", err: errors.New(`ent: missing required field "APIKey.smart_routing"`)}
	}
	if _, ok := _c.mutation.SmartRoutingCooldownSeconds(); !ok {
		return &ValidationError{Name: "smart_routing_cooldown_seconds", err: errors.New(`ent: missing required field "APIKey.smart_routing_cooldown_seconds"`)}
	}
	if v, ok := _c.mutation.SmartRoutingCooldownSeconds(); ok {
		if err := apikey.SmartRoutingCooldownSecondsValidator(v); err != nil {
			return &ValidationError{Name: "smart_routing_cooldown_seconds", err: fmt.Errorf(`ent: validator failed for field "APIKey.smart_routing_cooldown_seconds": %w`, err)}
		}
	}
	if _, ok := _c.mutation.Status(); !ok {
...
func (_c *APIKeyCreate) createSpec() (*APIKey, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.SmartRouting(); ok {
		_spec.SetField(apikey.FieldSmartRouting, field.TypeBool, value)
		_node.SmartRouting = value
	}
	if value, ok := _c.mutation.SmartRoutingCooldownSeconds(); ok {
		_spec.SetField(apikey.FieldSmartRoutingCooldownSeconds, field.TypeInt, value)
		_node.SmartRoutingCooldownSeconds = value
	}
...
// SetSmartRouting sets the "smart_routing" field.
func (u *APIKeyUpsert) SetSmartRouting(v bool) *APIKeyUpsert {
	u.Set(apikey.FieldSmartRouting, v)
	return u
}

// UpdateSmartRouting sets the "smart_routing" field to the value that was provided on create.
func (u *APIKeyUpsert) UpdateSmartRouting() *APIKeyUpsert {
	u.SetExcluded(apikey.FieldSmartRouting)
	return u
}

// SetSmartRoutingCooldownSeconds sets the "smart_routing_cooldown_seconds" field.
func (u *APIKeyUpsert) SetSmartRoutingCooldownSeconds(v int) *APIKeyUpsert {
	u.Set(apikey.FieldSmartRoutingCooldownSeconds, v)
	return u
}

// UpdateSmartRoutingCooldownSeconds sets the "smart_routing_cooldown_seconds" field to the value that was provided on create.
func (u *APIKeyUpsert) UpdateSmartRoutingCooldownSeconds() *APIKeyUpsert {
	u.SetExcluded(apikey.FieldSmartRoutingCooldownSeconds)
	return u
}

// AddSmartRoutingCooldownSeconds adds v to the "smart_routing_cooldown_seconds" field.
func (u *APIKeyUpsert) AddSmartRoutingCooldownSeconds(v int) *APIKeyUpsert {
	u.Add(apikey.FieldSmartRoutingCooldownSeconds, v)
	return u
}
...
// SetSmartRouting sets the "smart_routing" field.
func (u *APIKeyUpsertOne) SetSmartRouting(v bool) *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetSmartRouting(v)
	})
}
...
// UpdateSmartRouting sets the "smart_routing" field to the value that was provided on create.
func (u *APIKeyUpsertOne) UpdateSmartRouting() *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.UpdateSmartRouting()
	})
}

// SetSmartRoutingCooldownSeconds sets the "smart_routing_cooldown_seconds" field.
func (u *APIKeyUpsertOne) SetSmartRoutingCooldownSeconds(v int) *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetSmartRoutingCooldownSeconds(v)
	})
}

// AddSmartRoutingCooldownSeconds adds v to the "smart_routing_cooldown_seconds" field.
func (u *APIKeyUpsertOne) AddSmartRoutingCooldownSeconds(v int) *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.AddSmartRoutingCooldownSeconds(v)
	})
}

// UpdateSmartRoutingCooldownSeconds sets the "smart_routing_cooldown_seconds" field to the value that was provided on create.
func (u *APIKeyUpsertOne) UpdateSmartRoutingCooldownSeconds() *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
		s.UpdateSmartRoutingCooldownSeconds()
	})
}
...
// SetSmartRouting sets the "smart_routing" field.
func (u *APIKeyUpsertBulk) SetSmartRouting(v bool) *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetSmartRouting(v)
	})
}
...
// UpdateSmartRouting sets the "smart_routing" field to the value that was provided on create.
func (u *APIKeyUpsertBulk) UpdateSmartRouting() *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.UpdateSmartRouting()
	})
}
...
// SetSmartRoutingCooldownSeconds sets the "smart_routing_cooldown_seconds" field.
func (u *APIKeyUpsertBulk) SetSmartRoutingCooldownSeconds(v int) *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetSmartRoutingCooldownSeconds(v)
	})
}
...
// AddSmartRoutingCooldownSeconds adds v to the "smart_routing_cooldown_seconds" field.
func (u *APIKeyUpsertBulk) AddSmartRoutingCooldownSeconds(v int) *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.AddSmartRoutingCooldownSeconds(v)
	})
}
...
// UpdateSmartRoutingCooldownSeconds sets the "smart_routing_cooldown_seconds" field to the value that was provided on create.
func (u *APIKeyUpsertBulk) UpdateSmartRoutingCooldownSeconds() *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.UpdateSmartRoutingCooldownSeconds()
	})
}
