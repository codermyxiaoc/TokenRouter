...
func (s *OpenAIGatewayService) ForwardAlphaSearch(
	...
	resp, err := s.doOpenAIUpstream(req, proxyURL, account, s.resolveOpenAITLSProfile(account, tlsRouterMatch...))
...
// buildOpenAIAlphaSearchRequest 按官方 SearchClient 的最小线协议构建独立搜索请求，并保留查询参数。
