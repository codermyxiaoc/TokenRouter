...
describe('admin account duplicate API', () => {
  ...
  it('reuses the operation key after an ambiguous failed request', async () => {
    ...
    const storedKey = sessionStorage.getItem('tokenrouter:admin:account-duplicate:99')
    expect(storedKey).toBe('account-duplicate-99-11111111-1111-4111-8111-111111111111')
    expect(sessionStorage.getItem('sub2api:admin:account-duplicate:99')).toBeNull()
