...
marketplace: {
    ...
    viewGroupPricing: '查看模型定价',
    collapseGroupPricing: '收起模型定价',
    pricingStandard: '标准',
    pricingFast: 'Fast',
    imagePricing: '图片计费',
    videoPricing: '视频计费',
...
// User Subscriptions Page
  userSubscriptions: {
    ...
    resetCount: '已重置 {count} 次',
    resetCountHint: '本期每到一次早于订阅到期的额度重置时间就累计一次，无需发生用量。日额度按项目时区零点刷新，周/月额度按窗口起点每 7/30 天刷新；一次性日额度不重复刷新。首次激活和手动重置不计次。续费的新一期从 0 开始，管理员修改或延长有效期不清零。',
    quotaNoFurtherResetHint: '下一次额度重置时间已到或超过订阅到期时间，本期额度不再刷新；未用完的额度可用至订阅到期。',
    oneTimeQuotaHint: '该订阅的日额度为一次性额度，不会再次刷新；未用完的额度可用至订阅到期。',
...
// Payment System
  payment: {
    ...
    actualPay: '实付金额',
    createOrder: '确认支付',
    confirmWalletPayment: '确认余额支付',
    walletPaymentHint: '将从站内余额扣除 {amount}，用于购买或续费当前订阅。',
    walletInsufficientBalance: '站内余额不足，请先充值或选择其他支付方式。',
    methods: {
      balance: '站内余额',
      easypay: '易支付',
      alipay: '支付宝',
    ...
    errors: {
      ...
      INSUFFICIENT_BALANCE: '站内余额不足，请先充值或选择其他支付方式',
      WALLET_PAYMENT_DISABLED: '站内余额支付已关闭，请选择其他支付方式',
      WALLET_SUBSCRIPTION_ONLY: '站内余额仅可用于购买或续费订阅',
      INVALID_IDEMPOTENCY_KEY: '支付请求无效，请刷新页面后重试',
      IDEMPOTENCY_CONFLICT: '该支付请求已用于其他套餐，请重新选择套餐',
      WALLET_ORDER_STATE_INVALID: '该余额订单状态异常，请在订单页面查看状态或联系管理员',
    ...
    admin: {
      ...
      revenue: '支付金额',
      dailyRevenue: '每日支付金额',
      paymentStatisticsHint: '订单数量包含站内余额支付；美元金额已隐藏，其他币种分别展示，不等同于外部新增收款。平均余额单位购买单价仅统计外部支付订单。',
      statsCurrency: '统计币种',
