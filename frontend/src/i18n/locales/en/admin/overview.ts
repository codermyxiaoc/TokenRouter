...
// Groups
    groups: {
      ...
      availabilityProbe: {
        ...
        protocols: {
          auto: 'Automatic (account test strategy)',
          chat_completions: 'Chat Completions',
          responses: 'Responses',
          anthropic: 'Anthropic Messages',
          gemini: 'Gemini Native'
        },
        protocolAutoHint: 'Automatic uses the existing account test strategy. Adaptive accounts may test multiple endpoints; failure of any endpoint fails the probe.',
        protocolSelectedHint: 'Test only the selected upstream protocol. Other protocols do not affect this result. The account must support the selected protocol.',
        protocolOpenAIHint: 'OpenAI Chat Completions probes support API Key accounts only.',
        protocolOpenCodeHint: 'Jev models use SystemOne. Select Automatic for these models.',
        testNow: 'Test Now',
        testing: 'Testing…',
        testNowHint: 'Save the current probe settings and test once. The result is recorded in channel status. Save other group changes separately. This test does not retry.',
        createBeforeTest: 'Create and save the group first, then test it from the edit dialog.',
        testSuccess: 'Probe succeeded',
        testFailed: 'Probe failed',
        testLatency: 'Duration: {ms} ms',
        testAccount: 'Account #{id}',
        testRequestFailed: 'The probe request failed. Please try again later.',
        testBusy: 'This group already has a probe running. Try again after it finishes.',
