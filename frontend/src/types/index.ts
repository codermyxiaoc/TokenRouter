...
export interface ApiKey {
  ...
  // 智能路由候选按数组顺序尝试，分组摘要与 ID 顺序一致。
  smart_routing?: boolean
  smart_routing_group_ids?: number[]
  // 当前密钥的失败分组冷却秒数；0 仅关闭冷却，仍允许跨组故障转移。
  smart_routing_cooldown_seconds?: number
  smart_routing_groups?: Group[]
