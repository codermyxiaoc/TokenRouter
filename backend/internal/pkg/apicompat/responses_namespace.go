...
// FlattenResponsesNamespacesExcept 支持保留指定的服务端 namespace 声明，其余行为与
// FlattenResponsesNamespaces 相同。
...
// RestoreResponsesNamespaceCalls 将 JSON Responses 载荷中的摊平函数调用还原为
// Codex 所需的 namespace/name 身份。
