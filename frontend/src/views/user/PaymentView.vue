    ...
    <Teleport to="body">
      <Transition name="modal">
        <div v-if="showRenewalModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4" @click.self="closeRenewalModal">
          <div class="relative flex max-h-full w-full max-w-lg flex-col rounded-surface border border-gray-200 bg-white p-6 shadow-2xl dark:border-dark-700 dark:bg-dark-900 sm:rounded-dialog">
            <!-- Close button -->
