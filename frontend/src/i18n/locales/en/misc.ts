...
marketplace: {
    ...
    viewGroupPricing: 'View model pricing',
    collapseGroupPricing: 'Hide model pricing',
...
// User Subscriptions Page
  userSubscriptions: {
    ...
    resetCount: 'Reset {count} times',
    resetCountHint: 'Adds one for each quota reset time reached before this subscription expires, even without usage. Daily quotas refresh at midnight in the server time zone; weekly/monthly quotas refresh every 7/30 days from their window start. One-time daily quotas do not refresh again. Initial activation and manual resets are excluded. A new renewed term starts at 0; administrator edits or extensions do not clear the count.',
    quotaNoFurtherResetHint: 'The next quota reset falls at or after subscription expiry, so this term will not refresh again. Unused quota remains available until the subscription expires.',
    oneTimeQuotaHint: 'This subscription has a one-time daily quota with no further refresh. Unused quota remains available until the subscription expires.',
...
// Payment System
  payment: {
    ...
    confirmWalletPayment: 'Confirm Balance Payment',
    walletPaymentHint: '{amount} will be deducted from your account balance to purchase or renew this subscription.',
    walletInsufficientBalance: 'Insufficient account balance. Top up or choose another payment method.',
    methods: {
    ...
    errors: {
      ...
      INSUFFICIENT_BALANCE: 'Insufficient account balance. Top up or choose another payment method.',
      WALLET_PAYMENT_DISABLED: 'Account balance payments are disabled. Choose another payment method.',
      WALLET_SUBSCRIPTION_ONLY: 'Account balance can only purchase or renew subscriptions.',
      INVALID_IDEMPOTENCY_KEY: 'Invalid payment request. Refresh the page and try again.',
      IDEMPOTENCY_CONFLICT: 'This payment request belongs to another plan. Select the plan again.',
      WALLET_ORDER_STATE_INVALID: 'This balance order has an unexpected status. Check your orders or contact an administrator.',
    ...
    admin: {
      ...
      todayRevenue: 'Today Payment Amount',
      totalRevenue: 'Total Payment Amount',
      todayOrders: 'Today Orders',
      orderCount: 'Order Count',
      avgAmount: 'Average Amount',
      avgBalanceUnitPurchaseUnitPrice: 'Avg {unitName} Purchase Unit Price',
      revenue: 'Payment Amount',
      dailyRevenue: 'Daily Payment Amount',
      paymentStatisticsHint: 'Order counts include wallet payments. USD amounts are hidden; other currencies are shown separately and do not represent new external receipts. Average balance unit purchase price only includes external payments.',
      statsCurrency: 'Statistics Currency',
