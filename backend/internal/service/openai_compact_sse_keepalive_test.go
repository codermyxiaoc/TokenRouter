...
// TestOpenAICompactKeepaliveWriter_NilInnerWriter_NoPanic 覆盖内层 writer 释放后的
// 全部委托方法，确保迟到访问不会 panic。
...
// TestOpenAICompactKeepaliveWriter_NilKeepalive_NoPanic 验证缺少 keepalive 状态时，
// 写侧仍可安全委托给有效的内层 writer。
