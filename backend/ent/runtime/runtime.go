...
func init() {
	...
	// apikeyDescSmartRouting is the schema descriptor for smart_routing field.
	apikeyDescSmartRouting := apikeyFields[7].Descriptor()
	// apikey.DefaultSmartRouting holds the default value on creation for the smart_routing field.
	apikey.DefaultSmartRouting = apikeyDescSmartRouting.Default.(bool)
	// apikeyDescSmartRoutingCooldownSeconds is the schema descriptor for smart_routing_cooldown_seconds field.
	apikeyDescSmartRoutingCooldownSeconds := apikeyFields[8].Descriptor()
	// apikey.DefaultSmartRoutingCooldownSeconds holds the default value on creation for the smart_routing_cooldown_seconds field.
	apikey.DefaultSmartRoutingCooldownSeconds = apikeyDescSmartRoutingCooldownSeconds.Default.(int)
	// apikey.SmartRoutingCooldownSecondsValidator is a validator for the "smart_routing_cooldown_seconds" field. It is called by the builders before save.
	apikey.SmartRoutingCooldownSecondsValidator = func() func(int) error {
		validators := apikeyDescSmartRoutingCooldownSeconds.Validators
		fns := [...]func(int) error{
			validators[0].(func(int) error),
			validators[1].(func(int) error),
		}
		return func(smart_routing_cooldown_seconds int) error {
			for _, fn := range fns {
				if err := fn(smart_routing_cooldown_seconds); err != nil {
					return err
				}
			}
			return nil
	...
	apikeyDescFastModePolicy := apikeyFields[10].Descriptor()
	...
	apikeyDescFallbackToDefaultGroupWhenUnavailable := apikeyFields[29].Descriptor()
