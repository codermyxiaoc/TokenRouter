...
// B/C：第 3/4 步失败降级时 staff = &DingTalkStaffInfo{}，claims 不应有 nil。
...
// 第 3/4 步失败应降级（shouldFallback=true, isFatal=false）。
...
// E：CompleteDingTalkOAuthRegistration 的 username 兜底逻辑。
