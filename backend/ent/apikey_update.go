...
func (_u *APIKeyUpdate) SetSmartRouting(v bool) *APIKeyUpdate {
	_u.mutation.SetSmartRouting(v)
	return _u
}

// SetNillableSmartRouting sets the "smart_routing" field if the given value is not nil.
func (_u *APIKeyUpdate) SetNillableSmartRouting(v *bool) *APIKeyUpdate {
	if v != nil {
		_u.SetSmartRouting(*v)
	}
	return _u
}

// SetSmartRoutingCooldownSeconds sets the "smart_routing_cooldown_seconds" field.
func (_u *APIKeyUpdate) SetSmartRoutingCooldownSeconds(v int) *APIKeyUpdate {
	_u.mutation.ResetSmartRoutingCooldownSeconds()
	_u.mutation.SetSmartRoutingCooldownSeconds(v)
	return _u
}

// SetNillableSmartRoutingCooldownSeconds sets the "smart_routing_cooldown_seconds" field if the given value is not nil.
func (_u *APIKeyUpdate) SetNillableSmartRoutingCooldownSeconds(v *int) *APIKeyUpdate {
	if v != nil {
		_u.SetSmartRoutingCooldownSeconds(*v)
	}
	return _u
}

// AddSmartRoutingCooldownSeconds adds value to the "smart_routing_cooldown_seconds" field.
func (_u *APIKeyUpdate) AddSmartRoutingCooldownSeconds(v int) *APIKeyUpdate {
	_u.mutation.AddSmartRoutingCooldownSeconds(v)
	return _u
}
...
func (_u *APIKeyUpdate) check() error {
	...
	if v, ok := _u.mutation.SmartRoutingCooldownSeconds(); ok {
...
func (_u *APIKeyUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.SmartRouting(); ok {
		_spec.SetField(apikey.FieldSmartRouting, field.TypeBool, value)
	}
	if value, ok := _u.mutation.SmartRoutingCooldownSeconds(); ok {
		_spec.SetField(apikey.FieldSmartRoutingCooldownSeconds, field.TypeInt, value)
	}
	if value, ok := _u.mutation.AddedSmartRoutingCooldownSeconds(); ok {
		_spec.AddField(apikey.FieldSmartRoutingCooldownSeconds, field.TypeInt, value)
	}
...
// SetSmartRouting sets the "smart_routing" field.
func (_u *APIKeyUpdateOne) SetSmartRouting(v bool) *APIKeyUpdateOne {
	_u.mutation.SetSmartRouting(v)
	return _u
}

// SetNillableSmartRouting sets the "smart_routing" field if the given value is not nil.
func (_u *APIKeyUpdateOne) SetNillableSmartRouting(v *bool) *APIKeyUpdateOne {
	if v != nil {
		_u.SetSmartRouting(*v)
	}
	return _u
...
// SetSmartRoutingCooldownSeconds sets the "smart_routing_cooldown_seconds" field.
func (_u *APIKeyUpdateOne) SetSmartRoutingCooldownSeconds(v int) *APIKeyUpdateOne {
	_u.mutation.ResetSmartRoutingCooldownSeconds()
	_u.mutation.SetSmartRoutingCooldownSeconds(v)
	return _u
}
...
// SetNillableSmartRoutingCooldownSeconds sets the "smart_routing_cooldown_seconds" field if the given value is not nil.
func (_u *APIKeyUpdateOne) SetNillableSmartRoutingCooldownSeconds(v *int) *APIKeyUpdateOne {
	if v != nil {
		_u.SetSmartRoutingCooldownSeconds(*v)
	}
	return _u
...
// AddSmartRoutingCooldownSeconds adds value to the "smart_routing_cooldown_seconds" field.
func (_u *APIKeyUpdateOne) AddSmartRoutingCooldownSeconds(v int) *APIKeyUpdateOne {
	_u.mutation.AddSmartRoutingCooldownSeconds(v)
	return _u
}
