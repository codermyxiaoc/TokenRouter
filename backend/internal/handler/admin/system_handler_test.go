...
// TestSystemHandlerPerformUpdateSurvivesClientDisconnect 复现 #4504：浏览器或
// 反向代理中止长时间更新请求并取消请求上下文后，下载必须在有截止时间的独立上下文中
// 继续运行，不能因 "download failed: context canceled" 提前终止。
