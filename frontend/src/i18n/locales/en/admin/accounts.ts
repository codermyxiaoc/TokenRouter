    ...
    accounts: {
      ...
      cnProviders: {
        accountMode: {
          ...
          minimaxPaygDesc: 'Billed per token from the account balance. Balance queries are unavailable; Coding Plan usage queries are supported.',
          coding: 'Coding Plan',
      ...
      grok: {
        ...
        mediaTooLarge: 'File too large (images: 4 MB; audio: 6 MB).',
        mediaInvalidType: 'Unsupported file format. Choose an image or audio file.',
      ...
      testStreamInterrupted: 'The test connection ended without a completion result.',
      testEndpoint: 'Test endpoint',
      testEndpointHint: 'Applies only to this test and does not change the account protocol. Upstream support depends on its actual response.',
      testEndpoints: {
        auto: 'Auto (account configuration)',
      ...
      openaiQuotaReset: {
        ...
        resetSuccess: 'Reset succeeded: restored {windows} window(s)',
        resetCacheRefreshFailed: 'Reset succeeded, but the remaining credits could not be refreshed. Query credits again; do not repeat the reset.',
        resetAccountRecoveryFailed: 'Reset succeeded, but the local account rate-limit state could not be recovered. Refresh and check the account; do not repeat the reset.',
        resetAccountRefreshFailed: 'Reset succeeded, but the account state could not be refreshed. Refresh the account list; do not repeat the reset.',
        resetUnknown: 'The reset result is uncertain and a credit may have been consumed. Query quota and remaining credits before considering another reset.',
