...
func (s *adminServiceImpl) UpdateUser(ctx context.Context, id int64, input *UpdateUserInput) (*User, error) {
	...
	if emailChanged && normalizedEmail != "" {
		updateUser = func(updateCtx context.Context, updateUser *User, updateFields UserUpdateFields) error {
			return s.userRepo.UpdateWithNormalizedEmailGuard(updateCtx, updateUser, normalizedEmail, updateFields)
		}
	}
...
// tryAccrueAffiliateRebateForAdminRecharge 以尽力而为方式计提返利，不回滚已完成的余额调整。
