...
// SmartRouting applies equality check predicate on the "smart_routing" field. It's identical to SmartRoutingEQ.
func SmartRouting(v bool) predicate.APIKey {
	return predicate.APIKey(sql.FieldEQ(FieldSmartRouting, v))
}

// SmartRoutingCooldownSeconds applies equality check predicate on the "smart_routing_cooldown_seconds" field. It's identical to SmartRoutingCooldownSecondsEQ.
func SmartRoutingCooldownSeconds(v int) predicate.APIKey {
	return predicate.APIKey(sql.FieldEQ(FieldSmartRoutingCooldownSeconds, v))
}
...
// SmartRoutingEQ applies the EQ predicate on the "smart_routing" field.
func SmartRoutingEQ(v bool) predicate.APIKey {
	return predicate.APIKey(sql.FieldEQ(FieldSmartRouting, v))
}

// SmartRoutingNEQ applies the NEQ predicate on the "smart_routing" field.
func SmartRoutingNEQ(v bool) predicate.APIKey {
	return predicate.APIKey(sql.FieldNEQ(FieldSmartRouting, v))
}

// SmartRoutingCooldownSecondsEQ applies the EQ predicate on the "smart_routing_cooldown_seconds" field.
func SmartRoutingCooldownSecondsEQ(v int) predicate.APIKey {
	return predicate.APIKey(sql.FieldEQ(FieldSmartRoutingCooldownSeconds, v))
}

// SmartRoutingCooldownSecondsNEQ applies the NEQ predicate on the "smart_routing_cooldown_seconds" field.
func SmartRoutingCooldownSecondsNEQ(v int) predicate.APIKey {
	return predicate.APIKey(sql.FieldNEQ(FieldSmartRoutingCooldownSeconds, v))
}

// SmartRoutingCooldownSecondsIn applies the In predicate on the "smart_routing_cooldown_seconds" field.
func SmartRoutingCooldownSecondsIn(vs ...int) predicate.APIKey {
	return predicate.APIKey(sql.FieldIn(FieldSmartRoutingCooldownSeconds, vs...))
}

// SmartRoutingCooldownSecondsNotIn applies the NotIn predicate on the "smart_routing_cooldown_seconds" field.
func SmartRoutingCooldownSecondsNotIn(vs ...int) predicate.APIKey {
	return predicate.APIKey(sql.FieldNotIn(FieldSmartRoutingCooldownSeconds, vs...))
}

// SmartRoutingCooldownSecondsGT applies the GT predicate on the "smart_routing_cooldown_seconds" field.
func SmartRoutingCooldownSecondsGT(v int) predicate.APIKey {
	return predicate.APIKey(sql.FieldGT(FieldSmartRoutingCooldownSeconds, v))
}

// SmartRoutingCooldownSecondsGTE applies the GTE predicate on the "smart_routing_cooldown_seconds" field.
func SmartRoutingCooldownSecondsGTE(v int) predicate.APIKey {
	return predicate.APIKey(sql.FieldGTE(FieldSmartRoutingCooldownSeconds, v))
}

// SmartRoutingCooldownSecondsLT applies the LT predicate on the "smart_routing_cooldown_seconds" field.
func SmartRoutingCooldownSecondsLT(v int) predicate.APIKey {
	return predicate.APIKey(sql.FieldLT(FieldSmartRoutingCooldownSeconds, v))
}

// SmartRoutingCooldownSecondsLTE applies the LTE predicate on the "smart_routing_cooldown_seconds" field.
func SmartRoutingCooldownSecondsLTE(v int) predicate.APIKey {
	return predicate.APIKey(sql.FieldLTE(FieldSmartRoutingCooldownSeconds, v))
}
