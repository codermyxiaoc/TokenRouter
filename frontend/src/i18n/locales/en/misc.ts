...
// Payment System
  payment: {
    ...
    admin: {
      ...
      paymentStatisticsHint: 'Includes wallet payments, with amounts shown separately by currency. These totals are not new external receipts. Average balance unit purchase price only includes external payments.',
