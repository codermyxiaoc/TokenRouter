...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "smart_routing", Type: field.TypeBool, Default: false},
		{Name: "smart_routing_cooldown_seconds", Type: field.TypeInt, Default: 60, SchemaType: map[string]string{"postgres": "integer"}},
	...
	UserSubscriptionsColumns = []*schema.Column{
		...
		{Name: "weekly_usage_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "monthly_usage_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "daily_reset_count", Type: field.TypeInt64, Default: 0},
		{Name: "weekly_reset_count", Type: field.TypeInt64, Default: 0},
		{Name: "monthly_reset_count", Type: field.TypeInt64, Default: 0},
		{Name: "reset_counted_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	...
	UserSubscriptionsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UserSubscriptionsColumns[24], UserSubscriptionsColumns[6], UserSubscriptionsColumns[4], UserSubscriptionsColumns[5]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UserSubscriptionsColumns[24], UserSubscriptionsColumns[23], UserSubscriptionsColumns[4]},
			},
			{
